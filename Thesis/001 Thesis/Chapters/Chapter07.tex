...
\chapter{Rapid Information Factory Framework (RIFF) - Functional Layer - Synaptic Assimilator (SA)} % Main chapter title

\label{Chapter07} % Change X to a consecutive number; for referencing this chapter elsewhere, use \ref{ChapterX}

\lhead{Chapter 7. \emph{RIFF - FUNC - SA}} % Change X to a consecutive number; this is for the header on each page - perhaps a shortened title
