...
\chapter{Rapid Information Factory Framework (RIFF) - Functional Layer - Assess Superstep} % Main chapter title

\label{Chapter12} % Change X to a consecutive number; for referencing this chapter elsewhere, use \ref{ChapterX}

\lhead{Chapter 12. \emph{RIFF - FUNC - Assess}} % Change X to a consecutive number; this is for the header on each page - perhaps a shortened title
