...
\chapter{Rapid Information Factory Framework (RIFF) - Functional Layer - Organise Superstep} % Main chapter title

\label{Chapter15} % Change X to a consecutive number; for referencing this chapter elsewhere, use \ref{ChapterX}

\lhead{Chapter 15. \emph{RIFF - FUNC - Organise}} % Change X to a consecutive number; this is for the header on each page - perhaps a shortened title
