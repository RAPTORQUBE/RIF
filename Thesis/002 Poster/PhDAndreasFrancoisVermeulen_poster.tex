...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=4em]{standrews.jpg}} % First university/lab logo on the left
{\bf\textsc{Rapid Information Factory}\vspace{0.5em}} % Poster title
{\textsc{Andreas Francois Vermeulen \hspace{12pt} University of St Andrews and University of Dundee}} % Author names and institution
{\includegraphics[height=4em]{dundee.jpg}} % Second university/lab logo on the right
...
\item Machine Learning Engine - Rapid Information Factory
\item Processing Framework - Rapid Information Factory Framework
\item Cluster - Rapid Information Factory Cluster
\item Homogeneous Ontology for Recursive Uniform Schema (HORUS)
\item Load Person-Object-Location-Event Data
\item Rapid Information Factory Improvements  
\end{enumerate}
